...
[`references/pattern-study.md`](references/pattern-study.md) surveys **153 real
templates** across Rezi, Kickresume, Enhancv, Resume.io, Canva, Adobe Express, Figma
Community, Novorésumé and Microsoft Create — counted, not asserted:

| | |
|---|---|
| Two-column | **56%** (single column: 22%) |
| Decorative icons | **50%+** |
| Photo | **38%+** |
| Skill rating bars | **17%+** |
| One accent hue | **67%** |
...
Of 153 templates surveyed, **not one verifies its own output.**

The study also changed this tool: right-aligned dates turned out to be *a* convention,
not *the* convention (Adobe Express: 0 of 16), so `date_style: inline` was added; and
Novorésumé's pill-chip skills (10 of 12) were added as `skills_style: pills` — after
verifying they extract as a clean comma list.
...
assets/presets.yaml   107 named looks (generated by scripts/gen_presets.py)
